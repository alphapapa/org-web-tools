...
+  ~org-web-tools-attach-url-archive~: Download a Zip archive of a web page from [[http://archive.is/6AyZy][archive.is]] and attach with ~org-attach~.  (See also [[https://github.com/scallywag/org-board][org-board]]).
